...
void drawMan()
{
	...
	drawLine(H1.X1,H1.Y1,H1.X2,H1.Y2);
	drawLine(H2.X1,H2.Y1,H2.X2,H2.Y2);
	drawLine(L1.X1,L1.Y1,L1.X2,L1.Y2);
	drawLine(L2.X1,L2.Y1,L2.X2,L2.Y2);
...
void init_man()
{
	head.r = 25; head.X0 = 0; head.Y0 = 125;
	B.X1 = 0; B.X2 = 0; B.Y1 = 100; B.Y2 = -50;
	H1.X1 = -50; H1.X2 = 0; H1.Y1 = 0; H1.Y2 = 50;
	H2.X1 = 0; H2.X2 = 50; H2.Y1 = 50; H2.Y2 = 0;
	L1.X1 = -50; L1.X2 = 0; L1.Y1 = -150; L1.Y2 = -50;
	L2.X1 = 50; L2.X2 = 0; L2.Y1 = -150; L2.Y2 = -50;
}